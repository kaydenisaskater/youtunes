...
<div class="main-div">
	<div class="text-center">
	    ...
	    <p class="text-center" style="margin: 2%;padding: 3px;">
	...
	<div class="d-flex d-sm-flex flex-wrap mx-auto" style="padding: 10px;margin: 5px;width: 90%;">
		<%
		    ...
		    <div class="d-inline-flex d-sm-inline-flex d-md-inline-flex d-lg-flex d-xl-flex d-xxl-flex flex-grow-1 flex-shrink-0" style="padding: 10px;margin: 0px;">
		        <div class="card">
		            <div class="card-body">
		                ...
		                <h6 class="text-muted card-subtitle mb-2">$<%=String.format("%.2f", album.getPrice())%></h6>
		                <a class="card-link btn btn-primary" href="youtunes?action=albumDetails&albumId=<%=album.getAlbumId()%>">Edit</a>
		                <a class="card-link btn btn-danger" href="youtunes?action=deleteAlbum&albumId=<%=album.getAlbumId()%>">Delete</a>
		            </div>
		        </div>
		    </div>
		<%
