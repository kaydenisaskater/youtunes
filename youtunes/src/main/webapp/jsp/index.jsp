...
<jsp:include page="Navbar.jsp" flush="true"/>
	<div>
	    ...
	    Use YouTunes to purchase and download your favorite music.
	    </p>
	</div>
	<div>
		<%
		...
		<div class="d-flex d-sm-flex flex-wrap mx-auto" style="padding: 10px;margin: 5px;width: 70%;">
		    <div class="d-inline-flex d-sm-inline-flex d-md-inline-flex d-lg-flex d-xl-flex d-xxl-flex flex-grow-1 flex-shrink-0" style="padding: 10px;margin: 0px;">
		        <div class="card">
		            <div class="card-body">
		            	<img class="float-end" src="<%= request.getContextPath() + "/images/" + album.getImgUrl()%>" height="400"/>
		            	<% System.out.println(request.getContextPath() + "/images/" + album.getImgUrl()); %>
